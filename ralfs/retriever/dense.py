...
class DenseRetriever(BaseRetriever):
    ...
    def __init__(self, cfg):
        ...
        if dense_config and hasattr(dense_config, "model"):
            ...
            model_name = getattr(
                cfg.retriever, "dense_model", "sentence-transformers/all-MiniLM-L12-v2"
            )
    ...
    def load_index(self, index_path: Path | None = None) -> None:
        ...
        if not index_path.exists():
            raise FileNotFoundError(
                f"FAISS index not found: {index_path}. " "Run 'ralfs build-index' first."
            )
        ...
        try:
            ...
            if chunks_path and chunks_path.exists():
                ...
                raise FileNotFoundError(
                    f"Chunks file not found: {chunks_path}. " "Run 'ralfs preprocess' first."
                )
    ...
    def retrieve(
        ...
        try:
            ...
            for rank, (score, idx) in enumerate(zip(scores[0], indices[0], strict=False), 1):
